...
/**
 * This compiler pass searches for services tagged with 'prometheus_metrics_bundle.metric_info_resolver'. Thanks to this AppMetrics service can be configured with custom MetricInfoResolver which allows to customize the metric labels and recorded values.
 *
